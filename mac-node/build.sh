...
echo "==> building the Rust core for macOS (release, staticlib, gateway-rpc + polygon-gateway)…"
...
cargo build -p nimmesh-core --release --target aarch64-apple-darwin --lib --features "gateway-rpc polygon-gateway"
